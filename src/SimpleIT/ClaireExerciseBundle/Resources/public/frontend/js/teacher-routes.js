    ...
    ['$routeProvider', '$locationProvider', '$stateProvider',
        function ($routeProvider, $locationProvider, $stateProvider) {
            ...
            $stateProvider.state('model', {
                url: '/teacher/model',
                templateUrl: `${BASE_CONFIG.urls.partials.teacher}/partial-model-list.html?v=${buildVersion}`
            });

            $stateProvider.state('modelEdit', {
                url: '/teacher/model/:modelid',
                templateUrl: `${BASE_CONFIG.urls.partials.teacher}/partial-model-edit.html?v=${buildVersion}`
            });
            ...
            $stateProvider.state('modelEdit.resourceEdit', {
                ...
                templateUrl: `${BASE_CONFIG.urls.partials.teacher}/partial-resource-edit.html?v=${buildVersion}`
            });
